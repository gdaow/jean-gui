 ...
 */
#define jg_arguments_new(...)                     \
	jg_arguments_init((jg_value[]) {__VA_ARGS__}, \
	                  sizeof((jg_value[]) {__VA_ARGS__}))
 ...
 *
 * If the next argument isn't a bool, or there is no more arguments, the
 ...
 *
 * If the next argument isn't a int, or there is no more arguments, the behavior
 * is undefined.
 *
 * @param arguments Arguments to pop the value from.
 */
 ...
 *
 * If the next argument isn't a double, or there is no more arguments, the
 * behavior is undefined.
 *
 * @param arguments Arguments to pop the value from.
 */
 ...
 *
 * If the next argument isn't a string, or there is no more arguments, the
 * behavior is undefined.
 *
 * @param arguments Arguments to pop the value from.
 */
 ...
 *
 * If the next argument isn't a raw pointer, or there is no more arguments, the
 * behavior is undefined.
 *
 * @param arguments Arguments to pop the value from.
 */
 ...
 *
 * If the next argument isn't a object, or there is no more arguments, the
 * behavior is undefined.
 *
 * @param arguments Arguments to pop the value from.
 */
