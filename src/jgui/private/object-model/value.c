...
jg_value jg_none() {
	return (jg_value) {._type = JG_NONE};
}

jg_value jg_bool(bool value) {
	return (jg_value) {._type = JG_BOOLEAN, ._value._bool = value};
}

jg_value jg_int(int value) {
	return (jg_value) {._type = JG_INTEGER, ._value._int = value};
}

jg_value jg_double(double value) {
	return (jg_value) {._type = JG_DOUBLE, ._value._double = value};
}

jg_value jg_string(const char* value) {
	return (jg_value) {._type = JG_STRING, ._value._string = value};
}

jg_value jg_raw(void* value) {
	return (jg_value) {._type = JG_RAW, ._value._raw = value};
}

jg_value jg_object(void* value) {
	return (jg_value) {._type = JG_OBJECT, ._value._object = value};
}

bool jg_is_none(jg_value value) {
	return value._type == JG_NONE;
}
bool jg_is_bool(jg_value value) {
	return value._type == JG_BOOLEAN;
}
bool jg_is_int(jg_value value) {
	return value._type == JG_INTEGER;
}
bool jg_is_double(jg_value value) {
	return value._type == JG_DOUBLE;
}
bool jg_is_string(jg_value value) {
	return value._type == JG_STRING;
}
bool jg_is_raw(jg_value value) {
	return value._type == JG_RAW;
}
bool jg_is_object(jg_value value) {
	return value._type == JG_OBJECT;
}
