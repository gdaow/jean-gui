 ...
 * @param size   Size of object this class describes. Usually
 * sizeof(wrapped_c_type).
 */
 ...
 * jg_class_add_method or jg_class_add_property. If the member is not defined on
 * this class, it will be recursively searched in parent classes.
 *
 * @param member_name Name of the member to retrieve.
 *
 * @return A pointer to the retrieved member, or NULL if the member was not
 * found in this class or it's parents.
 */
const jg_member* jg_class_get_member(const jg_class* class_,
