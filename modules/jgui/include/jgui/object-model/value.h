 ...
 * 
 * jg_value wraps typed literals into a generic values, It's used with jg_object dynamic 
 * getters, setters and methods.
 *
 * Only int and double numerical values are supported. Supporting several stride for
 * integers and floating-point numbers would cause the number of jg_value-related
 * functions to grow rapidely. As it is supposed to be used in UI-binding related code,
 * int and double will suffice to represent all needed values, while memory usage induced
...
/**
  ...
  *
  * The string isn't copied, lifetime of the returned jg_value should be less than the given
  * string.
  *
  * @param value Value to wrap.
  *
