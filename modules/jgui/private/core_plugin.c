...
void jgui_core_plugin(jg_context_definition* context_definition) {
    jg_module_definition* core_module = jg_context_add_module(context_definition, jg_core_ns);
    jg_class_definition* object_class = jg_module_add_class(core_module, "Object", NULL, NULL, 0);
